        ...
        <header class="bg-white w-full shadow z-40 px-2">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-2">
                    <application-logo class="w-10 h-10" />
                    <button @click="showingNavigationDropdown = ! showingNavigationDropdown" class="inline-flex items-center justify-center p-2 rounded-md text-gray-600 hover:text-gray-700 hover:bg-gray-200 focus:outline-none bg-gray-200 focus:text-gray-700 transition duration-150 ease-in-out">
