    ...
    <app-layout>
        ...
        <div class="w-full flex">
            <Link
                ...
                class="text-center cursor-pointer border border-blue-600 text-white hover:bg-blue-700 bg-blue-600 rounded-md px-3 py-1.5"
            >
                + Add Package
            </Link>
        </div>
        ...
        >
            <template #default="{ item: product }">
                <td
                    ...
                    :class="{
                        'bg-red-200':
                            product.total_storage <= product.alert_quantity,
                    }"
                >
                    <div
                    ...
                    >
                        ...
                        <action-button-show
                            v-else
                            :href="route('packages.show', product.pacakge_id)"
                        />
                        <action-button-edit
                            v-if="product.type !== 1"
                        ...
                        <action-button-edit
                            v-else
                            :href="route('packages.edit', product.pacakge_id)"
                        />
                    </div>
                </td>
                <td
                ...
                <td
                    class="py-3 px-2 text-left flex"
                    :class="{
                        'bg-red-200':
                            product.total_storage <= product.alert_quantity,
                    }"
                >
                    ...
                    <div class="py-5">
                        ...
                        <div
                            v-else
                            class="border px-2 bg-indigo-500 text-white py-0.5 rounded cursor-pointer font-extrabold"
                            @click="modalHandler"
                        >
                            {{ product.name }} (
                            {{ product.package_product_names.length }} )
                        </div>

                        <div
                            v-if="product.package_product_names.length"
                                ...
                                >
                                    ...
                                    <div class="p-3">
                                        <div
                                            ...
                                            v-for="(
                                                pro, index
                                            ) in product.package_product_names"
                                            :key="index"
                                        >
                                            <span>{{ index + 1 }}.</span>
                                            <Link
                ...
                >
                    <span
                        ...
                        :class="{
                            'bg-green-500': product.active,
                            'bg-red-500': !product.active,
                        }"
                    >
                        {{ product.activeValue }}
                    </span>
                ...
                >
                    <span
                        class="py-1 px-3 rounded-full text-white font-bold"
                        :class="{
                            'bg-yellow-500': product.soft,
                            'bg-gray-500': !product.soft,
                        }"
                    >
                        {{ product.soft ? "Yes" : "No" }}
                    </span>
                ...
                >
                    ...
                    <div
                        v-if="product.moderators.length"
                        @click="modalHandler"
                            ...
                            >
                                ...
                                <div class="p-3">
                                    <div
                                        ...
                                        v-for="(
                                            moderator, index
                                        ) in product.moderators"
                                        :key="index"
                                    >
                                        {{ moderator.moderators_type.name }} :
                ...
                >
                    ...
                    <div
                        v-if="Object.keys(product.prices).length"
                        @click="modalHandler"
                        class="text-center border bg-gray-500 text-white px-2 py-0.5 rounded cursor-pointer"
                    >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="p-3">
                                    <div
                                        class="py-1.5 flex gap-2 mr-10"
                                        v-for="(
                                            priceCategory, index
                                        ) in product.priceCategories"
                                        :key="priceCategory"
                                    >
                        ...
                        <div class="relative w-full h-full flex justify-center items-center">
                            <div class="relative p-2 w-full mx-auto max-w-xs bg-white rounded border shadow z-50">
                                ...
                                <div class="flex justify-center">
                                    <div>
                                        <label for=""> In </label>
                                        <input type="radio" name="inOut" class="mr-2 checkBox"
                                            @click="form.type = 1; changeValue(product.id, product.storage_outlets);"
                                            value="1" required>
                                    </div>
                                    <div>
                                        <label for=""> Out </label>
                                        <input type="radio" name="inOut" class="checkBox" value="2"
                                            @click="form.type = 2; changeValue(product.id, product.storage_outlets, product.storages);"
                                            required>
                                    </div>
                                </div>
                                <hr class="my-1">
                                    ...
                                    <form @submit.prevent="submit('Circulation')" class="">
                                        <div class="mb-2 text-left">
                                            ...
                                            <Select id="outlet_id" class="mt-1 block w-full" v-model="form.from"
                                                :disabled="fromDisabled" required>
                                                <option value="">-- Select From--</option>
                                                <option :value="outletsId" v-for="(outletsName, outletsId) in outlets"
                                                    :key="outletsId">{{ outletsName }}</option>
                                            </Select>
                                        </div>
                                        <div class="mb-2 text-left">
                                            <Label value="To" />
                                            <Select id="outlet_id" class="mt-1 block w-full" v-model="form.to"
                                                :disabled="toDisabled" required>
                                        ...
                                        <Input id="type" type="number" class="mt-1 block w-full" placeholder="Quantity"
                            ...
                            <div class="relative p-2 w-full mx-auto max-w-lg bg-white rounded border shadow z-50">
                                <div class="p-3">
                                    <div v-for="(storage, index) in product.storages" :key="index" class="text-lg">
                                        <div v-for="productRequest in storage.product_requests" :key="productRequest.id"
                                            class="grid grid-cols-4 items-center justify-center">
                                            <div
                                                class="col-span-3 flex flex-col bg-gray-200 p-2 text-left rounded mt-2">
                                                    ...
                                                    <div class="flex items-center rounded mt-2">
                                                        ...
                                                        <div class="fixed inset-0 z-50" id="circulationWrapper"
                                                            ...
                                                            <div
                                                                        ...
                                                                        <form @submit.prevent="submit(product.id)"
                                                                            ...
                                                                            <div class="mb-2 text-left">
                                                                                ...
                                                                                <Select id="outlet_id"
                                                                                    ...
                                                                                    v-model="form.from" required>
                                                                                    <option value="">-- Select From--
                                                                                    </option>
                                                                                    <option :value="outletsId"
                                                                                        v-for="(outletsName, outletsId) in outlets"
                                                                                        :key="outletsId">{{ outletsName
                                                                                        }}</option>
                                                                                </Select>
                                                                            </div>
                                                                            <div class="mb-2 text-left">
                                                                                ...
                                                                                <Select id="outlet_id"
                                                                                    class="mt-1 block w-full"
                                                                                    v-model="form.to" :disabled="true"
                                                                                    required>
                                                                                    <option value="">-- Select To --
                                                                                    </option>
                                                                                    <option :value="outletsId"
                                                                                        v-for="(outletsName, outletsId) in outlets"
                                                                                        :key="outletsId">{{ outletsName
                                                                ...
                                                                <div
                                                                    class="absolute inset-0 bg-gray-500 bg-opacity-30 z-40">
                                                                    <div class="w-full h-full" @click="closeModal">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="text-left">
                                                <a class="bg-green-500 p-2 text-white rounded-r-lg"
                                                    :href="route('product-requests.show', productRequest.id)">Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="absolute right-2 top-0 cursor-pointer text-red-500 text-3xl z-40"
                                    @click="closeModal">&times;</div>
                            </div>
                            <div class="absolute inset-0 bg-gray-500 bg-opacity-30 z-40">
                                <div class="w-full h-full" @click="closeModal"></div>
                ...
                <!-- <td class="py-3 px-2 text-center"
                    ...
                    <div v-if="product.packageProductCount" @click="modalHandler"
                        ...
                        View {{ product.packageProducts }} products
                    </div>
                            ...
                            <div class="relative p-2 w-full mx-auto max-w-xs bg-white rounded border shadow z-50">
                                ...
                                <div class="p-3">
                                    <div class="py-1.5 flex gap-2"
                                        v-for="(packageProduct, index) in product.packageProducts" :key="index">
                                        <span>{{ index + 1 }}.</span>
                                        <Link class="underline hover:text-blue-500"
                                            :href="route('categories.show', packageProduct.id)">
                                        {{ packageProduct.name}}
                                        </Link>
                                    </div>
                                </div>
    ...
    methods: {
        ...
        showMessage(storages) {
            if (this.form.type == 2 && this.form.from) {
                storages.forEach((storage) => {
                    this.message = `This outlet has ${
                        storage.outlet_id == this.form.from
                            ? storage.quantity
                            : 0
                    } pieces`;
                });
        ...
        modalHandler(event, outlet_id = null, request_id = null) {
            ...
            if (outlet_id) {
                ...
                (this.form.type = 2), (this.form.request_id = request_id);
            }
        ...
        submit(product_id = null) {
            if (product_id) this.form.product_id = product_id;
