    ...
    <app-layout>
        ...
        >
            <template #default="{ item: publisher }">
                ...
                <td class="py-3 px-2 text-left">{{ publisher.phone }}</td>
                <td class="py-3 px-2 text-left">{{ publisher.email }}</td>
                <td class="py-2 px-2 text-center">
                    <span
                        class="py-1 px-3 rounded-full text-white font-bold"
                        :class="{
                            'bg-green-500': publisher.active,
                            'bg-red-500': !publisher.active,
                        }"
                    >
