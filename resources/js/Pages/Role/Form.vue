    ...
    <div class="w-full max-w-md mx-auto p-4 bg-white border shadow rounded">
        ...
        <form @submit.prevent="submit" class="">
            ...
            <div class="mb-4 overflow-auto h-screen">
                ...
                <div
                    class="w-full p-2 border-b cursor-pointer"
                    v-for="(permission, permissionId) in data.permissions"
                    :key="permissionId"
                    :class="{
                        'bg-blue-500': selected.includes(permissionId),
                        'text-white': selected.includes(permissionId),
                    }"
        ...
        submit() {
            ...
            if (this.moduleAction == "update") {
                return this.form.put(
                    this.route("roles.update", this.data.role.id)
                );
            }
        },
